...
class ImageMaker:
    ...
    def make_mockup(self):
        ...
        for mockup_number in range(4):
            if mockup_number == 0:
                ...
                self.mockup_dict[mockup_number] = 'Sun.jpg'
                ...
                self.mockup_dict[mockup_number] = 'Rain.jpg'
                ...
                self.mockup_dict[mockup_number] = 'Snow.jpg'
                ...
                self.mockup_dict[mockup_number] = 'Cloud.jpg'
    ...
    def draw_postcard(self):
        check_img = os.path.exists('Cloud.jpg')
        if not check_img:
            print('KEK')
            self.make_mockup()
        image = cv2.imread('Rain.jpg')
        cv2.putText(image, self.date, (210, 30), self.font, 1, self.color)
        cv2.putText(image, 'Погода', (50, 30), self.font, 1, self.color)
        cv2.putText(image, f'Температура днем: {self.r_color_delta}', (5, 90), self.font, 1, self.color)
        cv2.putText(image, f'Температура ночью: {self.r_color_delta}', (5, 140), self.font, 1, self.color)
        cv2.putText(image, f'{self.r_color_delta}', (5, 190), self.font, 1, self.color)
